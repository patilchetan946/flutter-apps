...
class _TODOAppUIState extends State<TODOAppUI> {
  ...
  //   final List<Taskclass> tasks = await getTaskData();
  //   setState(() {
  //     cardlist = tasks;
  //   });
  // }

  void submit(bool doedit, [Taskclass? taskclassobj]) {
    if (titleController.text.trim().isNotEmpty &&
        descriptionController.text.trim().isNotEmpty &&
        dateController.text.trim().isNotEmpty) {
      if (!doedit) {
        setState(() {
          cardlist.add(Taskclass(
  ...
  void editTask(Taskclass todoModelObj) {
    titleController.text = todoModelObj.title;
    descriptionController.text = todoModelObj.desp;
  ...
  Future<void> showBottomSht(bool doEdit, [Taskclass? todoModelObj]) async {
